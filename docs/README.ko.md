...
```sh
curl -fsSL https://raw.githubusercontent.com/Ameyanagi/yuru/v0.2.1/install | sh -s -- --all --version v0.2.1 --default-lang ko --preview-command auto --preview-image-protocol none --path-backend auto --bindings all
```
...
```powershell
$script = Invoke-RestMethod https://raw.githubusercontent.com/Ameyanagi/yuru/v0.2.1/install.ps1
Invoke-Expression "& { $script } -All -Version v0.2.1 -DefaultLang ko -PreviewCommand auto -PreviewImageProtocol none -PathBackend auto -Bindings all"
```
