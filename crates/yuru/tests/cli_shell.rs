...
fn cli_prints_powershell_shell_integration() {
    command()
        ...
        .stdout(predicate::str::contains("Invoke-YuruCommand"))
        .stdout(predicate::str::contains("Clear-YuruPendingConsoleInput"))
        .stdout(predicate::str::contains("YURU_FORCE_INTERACTIVE"))
        .stdout(predicate::str::contains("--input"))
